...
parser.add_argument('--variant', default='vector', type=str, choices=['vector', 'state', 'dynamic', 'vector_evolve', 'density_feature'])
parser.add_argument('--state_rank', default=1, type=int)
